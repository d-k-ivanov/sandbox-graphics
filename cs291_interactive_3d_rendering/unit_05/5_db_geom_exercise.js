...
function createDrinkingBird()
{
    ...
    // MODELS
    // base
    cube = new THREE.Mesh(new THREE.RoundedBoxGeometry(20 + 64 + 110, 4, 2 * 77 + 12, bevelRadius), footMaterial);
    ...
    // feet
    cube = new THREE.Mesh(new THREE.RoundedBoxGeometry(20 + 64 + 110, 52, 6, bevelRadius), footMaterial);
    cube.position.x = -45;                  // (20+32) - half of width (20+64+110)/2
    ...
    cube = new THREE.Mesh(new THREE.RoundedBoxGeometry(64, 104, 6, bevelRadius), footMaterial);
    ...
    // legs
    cube = new THREE.Mesh(new THREE.RoundedBoxGeometry(60, 282 + 4, 4, bevelRadius), legMaterial);
    cube.position.x = 0;	                // centered on origin along X
    ...
    // body
    sphere = new THREE.Mesh(new THREE.SphereGeometry(104 / 2, 32, 16, 0, Math.PI * 2, Math.PI / 2, Math.PI), bodyMaterial);
    sphere.position.x = 0;
    ...
    var tranform = new THREE.Matrix4();
    var xAxis = new THREE.Vector3(1, 0, 0);
    var yAxis = new THREE.Vector3(0, 1, 0);
    var zAxis = new THREE.Vector3(0, 0, 1);

    // YOUR CODE HERE: Add a crossbar support, a nose, and eyes.
    ...
    cylinder.matrix.makeTranslation(0, 360, 0);
    tranform.makeRotationX(90 * Math.PI / 180);
    cylinder.matrix.multiply(tranform);
    scene.add(cylinder);
    ...
    cylinder.matrixAutoUpdate = false;
    cylinder.matrix.makeTranslation(-70, 530, 0);
    tranform.makeRotationZ(90 * Math.PI / 180);
    cylinder.matrix.multiply(tranform);
    scene.add(cylinder);
    ...
    sphere = new THREE.SphereGeometry(10, 32, 16);
    var eye = new THREE.Mesh(sphere, eyeMaterial);
    eye.matrixAutoUpdate = false;
    eye.matrix.makeTranslation(-48, 560, 20);
    eye.matrix.multiply(tranform);
    scene.add(eye);

    eye = new THREE.Mesh(sphere, eyeMaterial);
    eye.matrixAutoUpdate = false;
    eye.matrix.makeTranslation(-48, 560, -20);
    eye.matrix.multiply(tranform);
    scene.add(eye);
