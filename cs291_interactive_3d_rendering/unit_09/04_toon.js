...
// toon (cel) shading: The shaders can be found in the files vertex.glsl and fragment.glsl
...
async function loadShadersAndRun() {
    ...
    vs = await (await fetch('unit_09/04_toon_vertex.glsl')).text();
    fs = await (await fetch('unit_09/04_toon_fragment.glsl')).text();
