...
function fillScene()
{
    ...
    var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(0, 80, 130, 32), faceMaterial);
    cylinder.position.x = 40;
    cylinder.position.y = 65;
    cylinder.position.z = 180;
    scene.add(cylinder);

    var sphere = new THREE.Mesh(new THREE.SphereGeometry(70, 32, 16), faceMaterial);
    ...
    movingSphere = new THREE.Mesh(new THREE.SphereGeometry(5, 32, 16), movingSphereMaterial);
    ...
    movingCube = new THREE.Mesh(new THREE.BoxGeometry(200, 50, 100), movingBoxMaterial);
    ...
    sphere = new THREE.Mesh(new THREE.SphereGeometry(5, 32, 16), sphereMaterial);
    sphere.position.x = 0;
    ...
    // , side: THREE.DoubleSide
    var cube = new THREE.Mesh(new THREE.BoxGeometry(50, 100, 200), boxMaterial);
    cube.position.x = 0;
    cube.position.y = 100;
    scene.add(cube);
}
