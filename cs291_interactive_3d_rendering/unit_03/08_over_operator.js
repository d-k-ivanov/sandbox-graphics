...
// ResultColor = Alpha * SourceColor + (1 - Alpha) * DestinationColor
...
function fillScene()
{
    ...
    var cube = new THREE.Mesh(new THREE.BoxGeometry(10, 50, 150), destMaterial);
    cube.position.x = 30;
    scene.add(cube);

    cube = new THREE.Mesh(new THREE.BoxGeometry(10, 150, 50), sourceMaterial);
    cube.position.x = -30;
    scene.add(cube);
}
