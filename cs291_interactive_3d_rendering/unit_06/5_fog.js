...
function init()
{
    ...
    // CAMERA
    camera = new THREE.PerspectiveCamera(35, canvasRatio, 1, 25000);
...
function render()
{
    ...
    renderer.setClearColor(new THREE.Color(hex), 1.0);

    if (oldFogOn !== effectController.fogOn || oldFogExp !== effectController.fogExp || scene === undefined)
    {
