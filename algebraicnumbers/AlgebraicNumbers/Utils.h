...
void dot(const SDL_Surface* surface, int x, int y, Uint32 pixel);
...
void wuCircle(const SDL_Surface* surface, int cx, int cy, int r, Uint32 color);
void rasterCircle(const SDL_Surface* surface, int x0, int y0, int radius, Uint32 color);
double fract(double x);
void bline(const SDL_Surface* surface, int x, int y, int x2, int y2, Uint32 color);
